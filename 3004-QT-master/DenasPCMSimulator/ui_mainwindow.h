...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        programOptions = new QListWidget(centralWidget);
        programOptions->setObjectName(QString::fromUtf8("programOptions"));
        programOptions->setGeometry(QRect(0, 30, 256, 221));
        programOptions->setSelectionRectVisible(false);
        MainWindow->setCentralWidget(centralWidget);
        programOptions->raise();
        selectButton->raise();
        batteryStatus->raise();
        upButton->raise();
        rightButton->raise();
