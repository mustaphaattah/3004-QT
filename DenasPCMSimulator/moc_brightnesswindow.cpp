...
QT_MOC_LITERAL(1, 17, 22), // "on_rightButton_clicked"
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 21), // "on_leftButton_clicked"
QT_MOC_LITERAL(4, 63, 23), // "on_selectButton_clicked"
QT_MOC_LITERAL(5, 87, 22) // "on_powerButton_clicked"

    },
    "BrightnessWindow\0on_rightButton_clicked\0"
    "\0on_leftButton_clicked\0on_selectButton_clicked\0"
...
void BrightnessWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<BrightnessWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_rightButton_clicked(); break;
...
QT_INIT_METAOBJECT const QMetaObject BrightnessWindow::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_BrightnessWindow.data,
    qt_meta_data_BrightnessWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
